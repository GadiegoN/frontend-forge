    ...
    async function loadReviews() {
      ...
      for (const doc of reviewSnapshots.docs) {
        ...
        const profileQueryRef = query(
          profileRef,
          where("uid", "==", reviewData.uid)
        );
        const profileSnapshots = await getDocs(profileQueryRef);

        const profileData =
          profileSnapshots.docs.map((profileDoc) => ({
            id: profileDoc.id,
  ...
  return (
    <div className="w-full max-w-7xl mx-auto gap-16">
        ...
        <div className="flex flex-col px-10 pb-1">
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            <Button
              ...
              className=""
            >
              {!showMore ? "Ler mais..." : "Ler menos"}
            </Button>
            <Button size="sm" onClick={DownloadPdf}>
              Baixar curriculo <Download className="size-4 ml-1" />
            </Button>
          </div>
      ...
      <div className="w-full flex flex-col mt-16">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold mt-4 select-none text-center">
          Meus serviços
        </h2>
        <div className="w-8/12 mx-auto">
          <p className="text-foreground my-4 text-center">
            Estou pronto para contribuir para o sucesso de novos projetos e
            equipes, trazendo minha experiência e paixão pelo desenvolvimento de
            software para ajudar a transformar suas ideias em realidade.
          </p>
        </div>
        ...
        <div className="w-full justify-center flex flex-wrap p-4 items-center gap-4">
          <div className="w-full max-w-[300px] hover:scale-105 select-none cursor-pointer bg-card shadow-2xl rounded-lg p-4 mx-auto flex flex-col justify-center items-center">
            ...
            <p className="text-foreground text-center font-mono">
              Sites, Blogs, E-commerce, Landing Pages
            </p>
          </div>
          <div className="w-full max-w-[300px] hover:scale-105 select-none cursor-pointer bg-card shadow-2xl rounded-lg p-4 mx-auto flex flex-col justify-center items-center">
      ...
      <div className="w-full flex flex-col mt-16 border-t">
        ...
        <div className="w-8/12 mx-auto">
          <p className="text-foreground my-4 text-center">
            Cada projeto representou um desafio único que contribuiu
            significativamente para meu crescimento profissional e para a
            entrega de soluções tecnológicas. Estou comprometido em continuar
            explorando novas tecnologias e metodologias para continuar
            entregando bons resultados em futuros projetos.
          </p>
        </div>
      ...
      <div className="w-full flex flex-col mt-16 border-t">
        ...
        <div className="w-8/12 mx-auto">
          <p className="text-foreground my-4 text-center">
            Utilizando as tecnologias mais inovadoras e eficientes para
            construir soluções web e mobile de alta performance.
          </p>
        </div>
      ...
      <div className="w-full flex flex-col mt-16">
        ...
        <div className="w-8/12 mx-auto">
          <p className="text-foreground my-4 text-center">
            Estas avaliações não apenas valida meu trabalho, mas também orienta
            meu compromisso com a excelência no desenvolvimento, garantindo
            sempre a entrega de resultados que superam expectativas.
          </p>
        </div>
            ...
            <div className="w-full justify-center flex flex-wrap p-4 items-center gap-4">
              ...
              <div className="w-full bg-card shadow-2xl rounded-lg p-4 mx-auto flex flex-col justify-center items-center">
                ...
                <div className="flex justify-between w-full">
                  ...
                  <a
                    target="_blank"
                    href="https://www.linkedin.com/in/gadiego-nogueira/"
                    className="text-lg hover:underline"
                  >
              ...
              <div className="w-full bg-card shadow-2xl rounded-lg p-4 mx-auto flex flex-col justify-center items-center">
                ...
                <div className="flex justify-between w-full">
                  ...
                  <a
                    target="_blank"
                    href="https://wa.me/5534984081905?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20seus%20servi%C3%A7os."
                    className="text-lg hover:underline"
                  >
                    Enviar mensagem
                  </a>
